...
public class ShopItem : MonoBehaviour {
	...
	public void InspectItem()
	{
		...
		} else 
		{
			...
			if(item.ItemClass == AccountInfo.ITEM_LIFEPASS || item.ItemClass == AccountInfo.ITEM_COINPACK || item.ItemClass ==  AccountInfo.ITEM_LEVELPACK || item.ItemClass == AccountInfo.ITEM_LEVELPACKBUNDLE)
			{
				MenuController.instance.NavBar.priceText.alignment=TMPro.TextAlignmentOptions.Center;
				if(item.ItemClass == "FullGameLevelPass")
				{
					MenuController.instance.NavBar.priceText.text= "Do you wish to purchase this Full Game Level Pack for £" + itemData.GBP.ToString("#.##")+"?";
				} else 
				{
