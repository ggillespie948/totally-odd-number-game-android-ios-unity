...
public class GridDataEditor : Editor
{
    ...
    //SerializedProperty lastValidHand;
	...
	void OnEnable()
	{
        ...
        //lastValidHand = serializedObject.FindProperty("lastValidHand");
	}
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Save Data")) // Just an example, you can remove this.
        {
            Debug.Log((target as Grid_Data).GetCountActiveCells());
        }
